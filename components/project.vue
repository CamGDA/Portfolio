<template>
  <v-card id="project" elevation="1" class="mx-15 my-8 pa-3" color="lighten2">
    ...
    <div class="d-flex flex-wrap justify-space-between">
      ...
      >
        ...
        <div>
          <v-chip class="ma-2 ml-4" color="blue" text-color="white" small>
            {{ project.chip1 }}
          </v-chip>
...
export default {
  ...
  data: () => ({
    projects: [
      ...
      {
        slide: 'PROJET 2',
        title: 'Epicerie en ligne',
        subtitle:
          "Site e-commerce en PHP avec inscription, connexion, modification d'un profil et panier",
        src: 'https://github.com/CamGDA/Epicerie-en-ligne',
        chip1: 'PHP',
        chip2: 'Bootstrap',
        chip3: 'MySQL',
      },
